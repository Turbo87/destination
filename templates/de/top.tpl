  ...
  <table cellspacing="0" cellpadding="5" align="left" style="HEIGHT: 100px; OVERFLOW: hidden;">
    <tbody>
      ...
      <tr id="navrow" style="HEIGHT: 28px; OVERFLOW: hidden;">
        ...
        <td class="link" style="WIDTH: 120px; PADDING-LEFT: 6px;" onclick="parent.content.location.href='index.php?c=%comp_id%&list';">Flugliste</td>
        <td class="link" style="WIDTH: 120px; PADDING-LEFT: 6px;" onclick="parent.content.location.href='index.php?c=%comp_id%&pilots';">Piloten</td>
        <td class="link" style="WIDTH: 120px; PADDING-LEFT: 6px;" onclick="parent.content.location.href='index.php?c=%comp_id%&stats';">Statistik</td>
